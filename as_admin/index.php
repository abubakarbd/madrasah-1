<?php include 'inc/header.php'; $month = 'echo date("M")'; ?>
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							<div class="icon">
								<i class="glyphicon fa fa-group" aria-hidden="true"></i>
							</div>
							<div class="four-text">
...
?> </h4>
				...
				<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							<div class="icon">
								<i class="glyphicon fa fa-money" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3><b>Total Income</b></h3>
								<h4> 
<?php 
...
echo $tsum; 
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon fa fa-search-minus" aria-hidden="true"></i>
							</div>
							<div class="four-text">
...
echo $tsum; 
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							<div class="icon">
								<i class="glyphicon fa fa-shopping-cart" aria-hidden="true"></i>
							</div>
							<div class="four-text">
								<h3><b>Monthli Cost</b></h3>
								<h4><?php 
