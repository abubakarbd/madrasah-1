	...
	<div class="col-sm-6">
		<div class="col-md-12 form-group2 group-mail">
            ...
            <div class="input-group">
				...
				<input type="text" name="name_b" class="form-control1" id="focusedinput" placeholder="শিক্ষার্থীর নাম (বাংলা)">
			</div>
       </div>
       ...
       <div class="col-md-12 form-group2 group-mail">
            ...
            <div class="input-group">
				...
				<input type="text" name="name_e" class="form-control1" id="focusedinput" placeholder="শিক্ষার্থীর নাম (ইংরেজী)">
			</div>
       </div>
       ...
       <div class="col-md-12 form-group2 group-mail">
            ...
            <div class="input-group">
				...
				<input type="text" name="fname_b" class="form-control1" id="focusedinput" placeholder="পিতার নাম (বাংলা)">
			</div>
       </div>
       ...
       <div class="col-md-12 form-group2 group-mail">
            ...
            <div class="input-group">
				...
				<input type="text" name="fname_e" class="form-control1" id="focusedinput" placeholder="পিতার নাম (ইংরেজী)">
			</div>
       </div>
       ...
       <div class="col-md-12 form-group2 group-mail">
           ...
           <div class="input-group">
				...
				<input type="text" name="mname_b" class="form-control1" id="focusedinput" placeholder="মাতার নাম (বাংলা)">
			</div>
       </div>
       ...
       <div class="col-md-12 form-group2 group-mail">
            ...
            <div class="input-group">
				...
				<input type="text" name="mname_e" class="form-control1" id="focusedinput" placeholder="মাতার নাম (ইংরেজী)">
			</div>
       </div>
       ...
       <div class="col-md-12 form-group2 group-mail">
            ...
            <div class="input-group">
				...
				<input type="text" name="c_name" class="form-control1" id="focusedinput" placeholder="যোগাযোগ রক্ষাকারী অভিভাবকের নাম">
			</div>
       </div>
       ...
       <div class="col-md-6 form-group2 group-mail">
            ...
            <div class="input-group">
				...
				<input type="text" name="c_relation" class="form-control1" id="focusedinput" placeholder="সম্পর্ক">
			</div>
       </div>
       ...
       <div class="col-md-6 form-group2 group-mail">
            ...
            <div class="input-group">
				...
				<input type="text" name="c_mobile" class="form-control1" id="focusedinput" placeholder="মোবাইল">
			</div>
       </div>
       ...
       <div class="col-md-6 form-group2 group-mail">
            ...
            <select name="division" id="dob-day">
			  <option>বিভাগ পছন্দ করুন</option>
...
<div class="col-sm-6">
    ...
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="mark" class="form-control1" id="focusedinput" placeholder="বিশেষ চিহ্ন">
		</div>
    </div>
    ...
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="level" class="form-control1" id="focusedinput" placeholder="উচ্চতা">
		</div>
    </div>
...
<!-- পিতার অংশ-->
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="f_job" class="form-control1" id="focusedinput" placeholder="পেশা">
		</div>
    </div>
    ...
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="fjob_ad" class="form-control1" id="focusedinput" placeholder="কর্ম স্থান">
		</div>
    </div>
    ...
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="f_mobile" class="form-control1" id="focusedinput" placeholder="মোবাইল">
		</div>
    </div>
    ...
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="f_nid" class="form-control1" id="focusedinput" placeholder="ভোটার আইডি নং">
		</div>
    </div>
    ...
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="m_job" class="form-control1" id="focusedinput" placeholder="পেশা">
		</div>
    </div>
    ...
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="mjob_ad" class="form-control1" id="focusedinput" placeholder="কর্ম স্থান">
		</div>
    </div>
    ...
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="m_mobile" class="form-control1" id="focusedinput" placeholder="মোবাইল">
		</div>
    </div>
    ...
    <div class="col-md-6 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="m_nid" class="form-control1" id="focusedinput" placeholder="ভোটার আইডি নং">
		</div>
    </div>
	...
	<div class="col-md-12 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="c_address" class="form-control1" id="focusedinput" placeholder="ঠিকানা">
		</div>
    </div>
    ...
    <div class="col-md-12 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="c_nid" class="form-control1" id="focusedinput" placeholder="ভোটার আইডি নং">
		</div>
    </div>
   ...
   <div class="col-md-4 form-group2 group-mail">
        ...
        <select name="car" id="dob-day">
				  <option>অবস্থান পছন্দ করুন</option>
				  <option value="car_in">গাড়িতে যাবে</option>
				  <option value="car_out">গাড়িতে যাবেনা</option>
			</select>
   </div>
   ...
   <div class="col-md-4 form-group2 group-mail">
		...
		<select name="old_class" id="dob-day">
				  <option>শ্রেণি পছন্দ করুন</option>
				  <option value="Najara">নাজেরা</option>
				  <option value="Hefz">হিফজ</option>
   ...
   <div class="col-md-12 form-group2 group-mail">
        ...
        <div class="input-group">
			...
			<input type="text" name="s_info" class="form-control1" id="focusedinput" placeholder="শিক্ষার্থীর বিষয়ে বিশেষ তথ্য">
		</div>
   </div>
</div>
...
<div class="col-md-12">
   ...
   <div class="col-md-4 form-group2 group-mail">
         <label class="control-label">শিক্ষার্থীর ছবিঃ</label>
        <div class="input-group">
			<span class="input-group-addon">
